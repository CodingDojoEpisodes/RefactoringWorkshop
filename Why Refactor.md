...
* We said that since the code is always kept valid, we tend to merge very often. This has 3 major advantages: First, it reduces the time we waste waiting to a minimum, second, it eliminates the hassle and risk involved in merging a big change. And third, it gives us the option to pivot to another task without losing the work that was already done.
