...
* First, when compared to rewrite, refactoring is a safer approach. If we take into consideration the time we save on debug and avoiding defects, it is also, in many cases, a faster one.
